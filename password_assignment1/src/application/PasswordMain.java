...
public class PasswordMain extends BorderPane
{
	...
	public void checkPassword() {
		...
		try
		{
			...
			if (PasswordCheckerUtility.isValidPassword(passwordString)) {
				...
				if(true) {
					PasswordCheckerUtility.isValidLength(passwordString);
					PasswordCheckerUtility.hasUpperAlpha(passwordString);
					PasswordCheckerUtility.hasLowerAlpha(passwordString);
					PasswordCheckerUtility.hasDigit(passwordString);
					PasswordCheckerUtility.hasSpecialChar(passwordString);
					PasswordCheckerUtility.hasSameCharInSequence(passwordString);
	...
	public void readFile() throws NoSpecialCharacterException, InvalidSequenceException, NoUpperAlphaException, NoDigitException, NoLowerAlphaException {
